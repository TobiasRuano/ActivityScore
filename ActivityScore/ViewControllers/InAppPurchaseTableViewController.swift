                ...
                SwiftyStoreKit.purchaseProduct(product, quantity: 1, atomically: true) { result in
                    ...
                    case .error(let error):
                        ...
                        case .unknown:
                            ...
                            self.alert(title: "Unknown error",
        ...
        SwiftyStoreKit.restorePurchases(atomically: true) { results in
            if !results.restoreFailedPurchases.isEmpty {
                ...
                self.alert(title: "Opps!",
                           message: "It seems there's a problem restoring your purchase. Please contact the developer",
                           buttonText: "Ok")
                TapticEffectsService.performFeedbackNotification(type: .error)
            } else if !results.restoredPurchases.isEmpty {
                print("Restore Success: \(results.restoredPurchases)")
                self.alert(title: "Purchase Restored!",
    ...
    func verifyRecipt() {
        ...
        SwiftyStoreKit.verifyReceipt(using: appleValidator) { result in
            ...
            case .error(let error):
                ...
                self.alert(title: "There is a problem validating your inApp Purchase",
                           message: "Please verify that you have an active internet connection. If the problem persist, contact the developer",
                           buttonText: "Ok")
            }
        }
        NetworkActivityIndicationManager.networkOperationFinished()
